...
func main() {
	...
	sss := fmt.Sprintf("TOTAL %d CTNS\n%s", 4, "TOTAL USD THREE THOUSAND TWO HUNDRED AND NINETY TWO DOLLARS ONLY")
	// Build the tables
	buildTable(pdf, table1Data, table2Data, table3Data, sss)
...
func buildTable(pdf *gofpdf.Fpdf, table1Data []Table1Row, table2Data []Table2Row, table3Data []Table3Row, lastStr string) {
	// Table 1
	pdf.SetX(20)
